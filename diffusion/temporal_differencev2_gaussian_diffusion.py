...
class TemporalDifferenceGaussianDiffusionV2:
    """
    ...
    def __str__(self):
        return "" \
        "TemporalDifferenceGaussianDiffusionV2: \n" \
    ...
    def training_losses(self, model, x_start, dx_start, t, model_kwargs=None, x_noise=None, dx_noise=None):
        ...
        x_start = interleave_frames(x_start, dx_start, frame_dim=1)
        x_noise = interleave_frames(x_noise, dx_noise, frame_dim=1)
        x_t = interleave_frames(x_t, dx_t, frame_dim=1)
        ...
        if self.loss_type == LossType.MSE or self.loss_type == LossType.RESCALED_MSE:
            ...
            if self.model_var_type in [
                ...
                x_vb_no_mean, dx_vb_no_mean = uninterleave_frames(vb_no_mean, frame_dim=1)
                terms["vb"] = vb
            ...
            x_mse_no_mean, dx_mse_no_mean = uninterleave_frames(mse_no_mean, frame_dim=1)
