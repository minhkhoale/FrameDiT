...
def main(args):
    ...
    logger.info('len(loader): {}, num_update_steps_per_epoch: {}'.format(len(loader), num_update_steps_per_epoch))
    ...
    for epoch in range(first_epoch, num_train_epochs):
        ...
        for step, video_data in enumerate(loader):
            ...
            #TODO: add diff norm
            x = combine_frames_and_difference(x, mean, combine_type='interleave')
