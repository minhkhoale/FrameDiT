...
class FaceForensicsImageLatent(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        params = torch.load(video_path, weights_only=False)[frame_indice]
        gaussian_dist = DiagonalGaussianDistribution(parameters=params)
        video_clip = gaussian_dist.sample()
    ...
    def load_video_frames_latent(self, dataroot):
        ...
        for latent_path in latent_files:
            ...
            if n_frames > 0:
                ...
                if 'flip' in os.path.basename(latent_path):
                    continue
