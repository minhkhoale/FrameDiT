...
#################################################################################
#                                 Core UnsqueezedFusedMatLatte Model                                #
#################################################################################

class TransformerBlock(nn.Module):
    """
    A UnsqueezedFusedMatLatte tansformer block with adaptive layer norm zero (adaLN-Zero) conditioning.
    """
...
class FusedMatrixTransformerBlock(nn.Module):
    ...
    def forward(self, x, c):
        ...
        x = x + gate_msa.unsqueeze(1) * rearrange(attn_x, 'b f n d -> (b n) f d')
        x = x + gate_mlp.unsqueeze(1) * self.mlp(modulate(self.norm2(x), shift_mlp, scale_mlp))
        return x
...
class FinalLayer(nn.Module):
    """
    The final layer of UnsqueezedFusedMatLatte.
    """
...
class UnsqueezedFusedMatLatte(nn.Module):
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        if not kwargs.get('vanilla_transformer'):
            self.blocks = nn.ModuleList([
                _transformer_block() if i % 2 == 0 else _mat_block() for i in range(depth)
            ])
        else:
            self.blocks = nn.ModuleList([
                _transformer_block() for i in range(depth)
        ])
...
#============================================================================================
def UnsqueezedFusedMatLatte_XL_2(**kwargs):
    return UnsqueezedFusedMatLatte(depth=28, hidden_size=1152, patch_size=2, num_row_heads=16, **kwargs)

def UnsqueezedFusedMatLatte_XL_4(**kwargs):
    return UnsqueezedFusedMatLatte(depth=28, hidden_size=1152, patch_size=4, num_row_heads=16, **kwargs)

def UnsqueezedFusedMatLatte_XL_8(**kwargs):
    return UnsqueezedFusedMatLatte(depth=28, hidden_size=1152, patch_size=8, num_row_heads=16, **kwargs)

def UnsqueezedFusedMatLatte_L_2(**kwargs):
    return UnsqueezedFusedMatLatte(depth=24, hidden_size=1024, patch_size=2, num_row_heads=16, **kwargs)

def UnsqueezedFusedMatLatte_L_4(**kwargs):
    return UnsqueezedFusedMatLatte(depth=24, hidden_size=1024, patch_size=4, num_row_heads=16, **kwargs)

def UnsqueezedFusedMatLatte_L_8(**kwargs):
    return UnsqueezedFusedMatLatte(depth=24, hidden_size=1024, patch_size=8, num_row_heads=16, **kwargs)

def UnsqueezedFusedMatLatte_M_2(**kwargs):
    return UnsqueezedFusedMatLatte(depth=12, hidden_size=1024, patch_size=2, num_row_heads=16, **kwargs)

def UnsqueezedFusedMatLatte_M_4(**kwargs):
    return UnsqueezedFusedMatLatte(depth=12, hidden_size=1024, patch_size=4, num_row_heads=16, **kwargs)

def UnsqueezedFusedMatLatte_M_8(**kwargs):
    return UnsqueezedFusedMatLatte(depth=12, hidden_size=1024, patch_size=8, num_row_heads=16, **kwargs)

def UnsqueezedFusedMatLatte_B_2(**kwargs):
    return UnsqueezedFusedMatLatte(depth=12, hidden_size=768, patch_size=2, num_row_heads=12, **kwargs)

def UnsqueezedFusedMatLatte_B_4(**kwargs):
    return UnsqueezedFusedMatLatte(depth=12, hidden_size=768, patch_size=4, num_row_heads=12, **kwargs)

def UnsqueezedFusedMatLatte_B_8(**kwargs):
    return UnsqueezedFusedMatLatte(depth=12, hidden_size=768, patch_size=8, num_row_heads=12, **kwargs)

def UnsqueezedFusedMatLatte_S_2(**kwargs):
    return UnsqueezedFusedMatLatte(depth=12, hidden_size=384, patch_size=2, num_row_heads=6, **kwargs)

def UnsqueezedFusedMatLatte_S_4(**kwargs):
    return UnsqueezedFusedMatLatte(depth=12, hidden_size=384, patch_size=4, num_row_heads=6, **kwargs)

def UnsqueezedFusedMatLatte_S_8(**kwargs):
    return UnsqueezedFusedMatLatte(depth=12, hidden_size=384, patch_size=8, num_row_heads=6, **kwargs)

# For image size 256
def UnsqueezedFusedMatLatte_XL_64_512_2(**kwargs):
    return UnsqueezedFusedMatLatte_XL_2(qk_col_dim=64, v_col_dim=512, num_col_heads=64, **kwargs)

def UnsqueezedFusedMatLatte_XL_128_512_2(**kwargs):
    return UnsqueezedFusedMatLatte_XL_2(qk_col_dim=128, v_col_dim=512, num_col_heads=128, **kwargs)

def UnsqueezedFusedMatLatte_XL_128_1024_2(**kwargs):
    return UnsqueezedFusedMatLatte_XL_2(qk_col_dim=128, v_col_dim=1024, num_col_heads=128, **kwargs)

def UnsqueezedFusedMatLatte_XL_256_256_2(**kwargs):
    return UnsqueezedFusedMatLatte_XL_2(qk_col_dim=256, v_col_dim=256, num_col_heads=256, **kwargs)

def UnsqueezedFusedMatLatte_XL_256_512_2(**kwargs):
    return UnsqueezedFusedMatLatte_XL_2(qk_col_dim=256, v_col_dim=512, num_col_heads=256, **kwargs)

# For image size 128, 64 tokens per frame
def UnsqueezedFusedMatLatte_M_1_256_2(**kwargs):
    return UnsqueezedFusedMatLatte_M_2(qk_col_dim=1, v_col_dim=256, num_col_heads=1, **kwargs)

def UnsqueezedFusedMatLatte_M_4_256_2(**kwargs):
    return UnsqueezedFusedMatLatte_M_2(qk_col_dim=4, v_col_dim=256, num_col_heads=4, **kwargs)

def UnsqueezedFusedMatLatte_M_4_512_2(**kwargs):
    return UnsqueezedFusedMatLatte_M_2(qk_col_dim=4, v_col_dim=512, num_col_heads=4, **kwargs)

def UnsqueezedFusedMatLatte_M_8_256_2(**kwargs):
    return UnsqueezedFusedMatLatte_M_2(qk_col_dim=8, v_col_dim=256, num_col_heads=8, **kwargs)

def UnsqueezedFusedMatLatte_M_16_512_2(**kwargs):
    return UnsqueezedFusedMatLatte_M_2(qk_col_dim=16, v_col_dim=512, num_col_heads=16, **kwargs)

def UnsqueezedFusedMatLatte_M_16_256_2(**kwargs):
    return UnsqueezedFusedMatLatte_M_2(qk_col_dim=16, v_col_dim=256, num_col_heads=16, **kwargs)

def UnsqueezedFusedMatLatte_M_16_256_2(**kwargs):
    return UnsqueezedFusedMatLatte_M_2(qk_col_dim=16, v_col_dim=256, num_col_heads=16, **kwargs)


# def UnsqueezedFusedMatLatte_M_16_64_2(**kwargs):
#     return UnsqueezedFusedMatLatte_M_2(qk_col_dim=16, v_col_dim=64, num_col_heads=16, **kwargs)

def UnsqueezedFusedMatLatte_M_32_256_2(**kwargs):
    return UnsqueezedFusedMatLatte_M_2(qk_col_dim=32, v_col_dim=256, num_col_heads=32, **kwargs)

def UnsqueezedFusedMatLatte_M_64_64_2(**kwargs):
    return UnsqueezedFusedMatLatte_M_2(qk_col_dim=64, v_col_dim=64, num_col_heads=64, **kwargs)

def UnsqueezedFusedMatLatte_M_64_256_2_gated(**kwargs):
    return UnsqueezedFusedMatLatte_M_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, fuse_mode='gated', **kwargs)

def UnsqueezedFusedMatLatte_M_64_256_2_concat(**kwargs):
    return UnsqueezedFusedMatLatte_M_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, fuse_mode='concat', **kwargs)

def UnsqueezedFusedMatLatte_M_64_256_2_sum(**kwargs):
    return UnsqueezedFusedMatLatte_M_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, fuse_mode='sum', **kwargs)

def UnsqueezedFusedMatLatte_M_16_64_2_gated(**kwargs):
    return UnsqueezedFusedMatLatte_M_2(qk_col_dim=16, v_col_dim=64, num_col_heads=16, fuse_mode='gated', **kwargs)

def UnsqueezedFusedMatLatte_M_16_64_2_concat(**kwargs):
    return UnsqueezedFusedMatLatte_M_2(qk_col_dim=16, v_col_dim=64, num_col_heads=16, fuse_mode='concat', **kwargs)

def UnsqueezedFusedMatLatte_M_16_64_2_sum(**kwargs):
    return UnsqueezedFusedMatLatte_M_2(qk_col_dim=16, v_col_dim=64, num_col_heads=16, fuse_mode='sum', **kwargs)

def UnsqueezedFusedMatLatte_M_4_64_2_concat(**kwargs):
    return UnsqueezedFusedMatLatte_M_2(qk_col_dim=4, v_col_dim=64, num_col_heads=4, fuse_mode='concat', **kwargs)

def UnsqueezedFusedMatLatte_M_2_onlylocal(**kwargs):
    return UnsqueezedFusedMatLatte_M_2(qk_col_dim=None, v_col_dim=None, num_col_heads=None, fuse_mode='local', **kwargs)

def UnsqueezedFusedMatLatte_M_2_vanilla(**kwargs):
    return UnsqueezedFusedMatLatte_M_2(qk_col_dim=None, v_col_dim=None, num_col_heads=None, vanilla_transformer=True, **kwargs)

# For image size 64
def UnsqueezedFusedMatLatte_B_16_16_2(**kwargs):
    return UnsqueezedFusedMatLatte_B_2(qk_col_dim=16, v_col_dim=16, num_col_heads=16, **kwargs)

#============================================================================================
UnsqueezedFusedMatLatte_models = {
    'UnsqueezedFusedMatLatte-M/4-64/2-concat': UnsqueezedFusedMatLatte_M_4_64_2_concat,
    'UnsqueezedFusedMatLatte-M/16-64/2-gated': UnsqueezedFusedMatLatte_M_16_64_2_gated,
    'UnsqueezedFusedMatLatte-M/16-64/2-concat': UnsqueezedFusedMatLatte_M_16_64_2_concat,
    'UnsqueezedFusedMatLatte-M/16-64/2-sum': UnsqueezedFusedMatLatte_M_16_64_2_sum,
    'UnsqueezedFusedMatLatte-M/64-256/2-gated': UnsqueezedFusedMatLatte_M_64_256_2_gated,
    'UnsqueezedFusedMatLatte-M/64-256/2-concat': UnsqueezedFusedMatLatte_M_64_256_2_concat,
    'UnsqueezedFusedMatLatte-M/64-256/2-sum': UnsqueezedFusedMatLatte_M_64_256_2_sum,
    'UnsqueezedFusedMatLatte-M/2-onlylocal': UnsqueezedFusedMatLatte_M_2_onlylocal,
    'UnsqueezedFusedMatLatte-M/2-vanilla': UnsqueezedFusedMatLatte_M_2_vanilla,
}

    # 'UnsqueezedFusedMatLatte-B/16-16/2': UnsqueezedFusedMatLatte_B_16_16_2,
    # 'UnsqueezedFusedMatLatte-M/1-256/2': UnsqueezedFusedMatLatte_M_1_256_2,
    # 'UnsqueezedFusedMatLatte-M/4-256/2': UnsqueezedFusedMatLatte_M_4_256_2, 'UnsqueezedFusedMatLatte-M/4-512/2': UnsqueezedFusedMatLatte_M_4_512_2, 
    # 'UnsqueezedFusedMatLatte-M/8-256/2': UnsqueezedFusedMatLatte_M_8_256_2, 
    # 'UnsqueezedFusedMatLatte-M/16-64/2': UnsqueezedFusedMatLatte_M_16_64_2, 'UnsqueezedFusedMatLatte-M/16-256/2': UnsqueezedFusedMatLatte_M_16_256_2, 'UnsqueezedFusedMatLatte-M/16-512/2': UnsqueezedFusedMatLatte_M_16_512_2,
    # 'UnsqueezedFusedMatLatte-M/32-256/2': UnsqueezedFusedMatLatte_M_32_256_2,
    # 'UnsqueezedFusedMatLatte-M/64-64/2': UnsqueezedFusedMatLatte_M_64_64_2, 'UnsqueezedFusedMatLatte-M/64-256/2': UnsqueezedFusedMatLatte_M_64_256_2,
    # 'UnsqueezedFusedMatLatte-XL/64-512/2': UnsqueezedFusedMatLatte_XL_64_512_2, 'UnsqueezedFusedMatLatte-XL/128-512/2': UnsqueezedFusedMatLatte_XL_128_512_2, 'UnsqueezedFusedMatLatte-XL/256-256/2': UnsqueezedFusedMatLatte_XL_256_256_2,
    # 'UnsqueezedFusedMatLatte-XL/128-1024/2': UnsqueezedFusedMatLatte_XL_128_1024_2, 'UnsqueezedFusedMatLatte-XL/256-512/2': UnsqueezedFusedMatLatte_XL_256_512_2
...
if __name__ == '__main__':
    ...
    network = UnsqueezedFusedMatLatte_XL_2().to(device)
