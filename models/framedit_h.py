...
#################################################################################
#                                 Core FrameDiT_H Model                                #
#################################################################################

class TransformerBlock(nn.Module):
    """
    A FrameDiT_H tansformer block with adaptive layer norm zero (adaLN-Zero) conditioning.
    """
...
#============================================================================================
def FrameDiT_H_XL_2(**kwargs):
    return FrameDiT_H(depth=28, hidden_size=1152, patch_size=2, num_row_heads=16, **kwargs)

def FrameDiT_H_L_2(**kwargs):
    return FrameDiT_H(depth=24, hidden_size=1024, patch_size=2, num_row_heads=16, **kwargs)

def FrameDiT_H_B_2(**kwargs):
    return FrameDiT_H(depth=12, hidden_size=768, patch_size=2, num_row_heads=12, **kwargs)

def FrameDiT_H_S_2(**kwargs):
    return FrameDiT_H(depth=12, hidden_size=384, patch_size=2, num_row_heads=6, **kwargs)

def FrameDiT_H_S_64_256_2_softmax_u_concat(**kwargs):
    return FrameDiT_H_S_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, fuse_mode='concat', u_type='softmax', **kwargs)

def FrameDiT_H_B_64_256_2_softmax_u_concat(**kwargs):
    return FrameDiT_H_B_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, fuse_mode='concat', u_type='softmax', **kwargs)

def FrameDiT_H_L_64_256_2_softmax_u_concat(**kwargs):
    return FrameDiT_H_L_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, fuse_mode='concat', u_type='softmax', **kwargs)

def FrameDiT_H_XL_64_256_2_softmax_u_concat(**kwargs):
    return FrameDiT_H_XL_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, fuse_mode='concat', u_type='softmax', **kwargs)


def FrameDiT_H_S_64_256_2_concat(**kwargs):
    return FrameDiT_H_S_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, fuse_mode='concat', **kwargs)

def FrameDiT_H_B_64_256_2_concat(**kwargs):
    return FrameDiT_H_B_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, fuse_mode='concat', **kwargs)

def FrameDiT_H_L_64_256_2_concat(**kwargs):
    return FrameDiT_H_L_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, fuse_mode='concat', **kwargs)

def FrameDiT_H_XL_64_256_2_concat(**kwargs):
    return FrameDiT_H_XL_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, fuse_mode='concat', **kwargs)


def FrameDiT_H_S_128_512_2_softmax_u_concat(**kwargs):
    return FrameDiT_H_S_2(qk_col_dim=128, v_col_dim=512, num_col_heads=64, fuse_mode='concat', u_type='softmax', **kwargs)

def FrameDiT_H_B_128_512_2_softmax_u_concat(**kwargs):
    return FrameDiT_H_B_2(qk_col_dim=128, v_col_dim=512, num_col_heads=64, fuse_mode='concat', u_type='softmax', **kwargs)

def FrameDiT_H_L_128_512_2_softmax_u_concat(**kwargs):
    return FrameDiT_H_L_2(qk_col_dim=128, v_col_dim=512, num_col_heads=64, fuse_mode='concat', u_type='softmax', **kwargs)

def FrameDiT_H_XL_128_512_2_softmax_u_concat(**kwargs):
    return FrameDiT_H_XL_2(qk_col_dim=128, v_col_dim=512, num_col_heads=64, fuse_mode='concat', u_type='softmax', **kwargs)


def FrameDiT_H_S_128_512_2_concat(**kwargs):
    return FrameDiT_H_S_2(qk_col_dim=128, v_col_dim=512, num_col_heads=64, fuse_mode='concat', **kwargs)

def FrameDiT_H_B_128_512_2_concat(**kwargs):
    return FrameDiT_H_B_2(qk_col_dim=128, v_col_dim=512, num_col_heads=64, fuse_mode='concat', **kwargs)

def FrameDiT_H_L_128_512_2_concat(**kwargs):
    return FrameDiT_H_L_2(qk_col_dim=128, v_col_dim=512, num_col_heads=64, fuse_mode='concat', **kwargs)

def FrameDiT_H_XL_128_512_2_concat(**kwargs):
    return FrameDiT_H_XL_2(qk_col_dim=128, v_col_dim=512, num_col_heads=64, fuse_mode='concat', **kwargs)

#============================================================================================
FrameDiTH_models = {
    'FrameDiTH-S/64-256/2-softmax_u-concat': FrameDiT_H_S_64_256_2_softmax_u_concat,
    'FrameDiTH-B/64-256/2-softmax_u-concat': FrameDiT_H_B_64_256_2_softmax_u_concat,
    'FrameDiTH-L/64-256/2-softmax_u-concat': FrameDiT_H_L_64_256_2_softmax_u_concat,
    'FrameDiTH-XL/64-256/2-softmax_u-concat': FrameDiT_H_XL_64_256_2_softmax_u_concat,

    'FrameDiTH-S/64-256/2-concat': FrameDiT_H_S_64_256_2_concat,
    'FrameDiTH-B/64-256/2-concat': FrameDiT_H_B_64_256_2_concat,
    'FrameDiTH-L/64-256/2-concat': FrameDiT_H_L_64_256_2_concat,
    'FrameDiTH-XL/64-256/2-concat': FrameDiT_H_XL_64_256_2_concat,

    'FrameDiTH-S/128-512/2-softmax_u-concat': FrameDiT_H_S_128_512_2_softmax_u_concat,
    'FrameDiTH-B/128-512/2-softmax_u-concat': FrameDiT_H_B_128_512_2_softmax_u_concat,
    'FrameDiTH-L/128-512/2-softmax_u-concat': FrameDiT_H_L_128_512_2_softmax_u_concat,
    'FrameDiTH-XL/128-512/2-softmax_u-concat': FrameDiT_H_XL_128_512_2_softmax_u_concat,

    'FrameDiTH-S/128-512/2-concat': FrameDiT_H_S_128_512_2_concat,
    'FrameDiTH-B/128-512/2-concat': FrameDiT_H_B_128_512_2_concat,
    'FrameDiTH-L/128-512/2-concat': FrameDiT_H_L_128_512_2_concat,
    'FrameDiTH-XL/128-512/2-concat': FrameDiT_H_XL_128_512_2_concat,
}
