...
#################################################################################
#                                 Core FrameDiT_G_IMG Model                                #
#################################################################################

class TransformerBlock(nn.Module):
    """
    A FrameDiT_G_IMG tansformer block with adaptive layer norm zero (adaLN-Zero) conditioning.
    """
...
class FinalLayer(nn.Module):
    """
    The final layer of FrameDiT_G_IMG.
    """
...
class FrameDiT_G_IMG(nn.Module):
    """
    ...
    def initialize_weights(self):
        ...
        # Zero-out adaLN modulation layers in FrameDiT_G_IMG blocks:
    ...
    def forward(self, x, t, y=None, use_fp16=False, y_image=None, use_image_num=0):
        """
        Forward pass of FrameDiT_G_IMG.
    ...
    def forward_with_cfg(self, x, t, y=None, cfg_scale=7.0, use_fp16=False):
        """
        Forward pass of FrameDiT_G_IMG, but also batches the unconditional forward pass for classifier-free guidance.
        """
...
#################################################################################
#                                   FrameDiT_G_IMG Configs                                  #
#################################################################################
# def FrameDiT_G_IMG_XL_64_128_2(**kwargs):
#     return FrameDiT_G_IMG(depth=28, hidden_size=1152, patch_size=2, qk_col_dim=64, v_col_dim=128, num_col_heads=64, num_row_heads=16, **kwargs)

# def FrameDiT_G_IMG_XL_64_128_2(**kwargs):
#     return FrameDiT_G_IMG(depth=28, hidden_size=1152, patch_size=2, qk_col_dim=64, v_col_dim=128, num_col_heads=64, num_row_heads=16, **kwargs)

# def FrameDiT_G_IMG_XL_256_256_2(**kwargs):
#     return FrameDiT_G_IMG(depth=28, hidden_size=1152, patch_size=2, qk_col_dim=256, v_col_dim=256, num_col_heads=64, num_row_heads=16, **kwargs)
#
...
#============================================================================================
def FrameDiT_G_IMG_XL_2(**kwargs):
    return FrameDiT_G_IMG(depth=28, hidden_size=1152, patch_size=2, num_row_heads=16, **kwargs)

def FrameDiT_G_IMG_L_2(**kwargs):
    return FrameDiT_G_IMG(depth=24, hidden_size=1024, patch_size=2, num_row_heads=16, **kwargs)

def FrameDiT_G_IMG_B_2(**kwargs):
    return FrameDiT_G_IMG(depth=12, hidden_size=768, patch_size=2, num_row_heads=12, **kwargs)

def FrameDiT_G_IMG_S_2(**kwargs):
    return FrameDiT_G_IMG(depth=12, hidden_size=384, patch_size=2, num_row_heads=6, **kwargs)

# For image size 256
def FrameDiT_G_IMG_XL_64_256_2_softmax_u(**kwargs):
    return FrameDiT_G_IMG_XL_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, u_type='softmax', **kwargs)

def FrameDiT_G_IMG_L_64_256_2_softmax_u(**kwargs):
    return FrameDiT_G_IMG_L_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, u_type='softmax', **kwargs)

def FrameDiT_G_IMG_B_64_256_2_softmax_u(**kwargs):
    return FrameDiT_G_IMG_B_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, u_type='softmax', **kwargs)

def FrameDiT_G_IMG_S_64_256_2_softmax_u(**kwargs):
    return FrameDiT_G_IMG_S_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, u_type='softmax', **kwargs)


def FrameDiT_G_IMG_XL_64_256_2(**kwargs):
    return FrameDiT_G_IMG_XL_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, **kwargs)

def FrameDiT_G_IMG_L_64_256_2(**kwargs):
    return FrameDiT_G_IMG_L_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, **kwargs)

def FrameDiT_G_IMG_B_64_256_2(**kwargs):
    return FrameDiT_G_IMG_B_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, **kwargs)

def FrameDiT_G_IMG_S_64_256_2(**kwargs):
    return FrameDiT_G_IMG_S_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, **kwargs)


def FrameDiT_G_IMG_XL_128_512_2_softmax_u(**kwargs):
    return FrameDiT_G_IMG_XL_2(qk_col_dim=128, v_col_dim=512, num_col_heads=64, u_type='softmax', **kwargs)

def FrameDiT_G_IMG_L_128_512_2_softmax_u(**kwargs):
    return FrameDiT_G_IMG_L_2(qk_col_dim=128, v_col_dim=512, num_col_heads=64, u_type='softmax', **kwargs)

def FrameDiT_G_IMG_B_128_512_2_softmax_u(**kwargs):
    return FrameDiT_G_IMG_B_2(qk_col_dim=128, v_col_dim=512, num_col_heads=64, u_type='softmax', **kwargs)

def FrameDiT_G_IMG_S_128_512_2_softmax_u(**kwargs):
    return FrameDiT_G_IMG_S_2(qk_col_dim=128, v_col_dim=512, num_col_heads=64, u_type='softmax', **kwargs)


def FrameDiT_G_IMG_XL_128_512_2(**kwargs):
    return FrameDiT_G_IMG_XL_2(qk_col_dim=128, v_col_dim=512, num_col_heads=64, **kwargs)

def FrameDiT_G_IMG_L_128_512_2(**kwargs):
    return FrameDiT_G_IMG_L_2(qk_col_dim=128, v_col_dim=512, num_col_heads=64, **kwargs)

def FrameDiT_G_IMG_B_128_512_2(**kwargs):
    return FrameDiT_G_IMG_B_2(qk_col_dim=128, v_col_dim=512, num_col_heads=64, **kwargs)

def FrameDiT_G_IMG_S_128_512_2(**kwargs):
    return FrameDiT_G_IMG_S_2(qk_col_dim=128, v_col_dim=512, num_col_heads=64, **kwargs)

#============================================================================================
FrameDiTGIMG_models = {
    'FrameDiTGIMG-S/64-256/2-softmax_u': FrameDiT_G_IMG_S_64_256_2_softmax_u,
    'FrameDiTGIMG-B/64-256/2-softmax_u': FrameDiT_G_IMG_B_64_256_2_softmax_u,
    'FrameDiTGIMG-L/64-256/2-softmax_u': FrameDiT_G_IMG_L_64_256_2_softmax_u,
    'FrameDiTGIMG-XL/64-256/2-softmax_u': FrameDiT_G_IMG_XL_64_256_2_softmax_u,

    'FrameDiTGIMG-S/64-256/2': FrameDiT_G_IMG_S_64_256_2,
    'FrameDiTGIMG-B/64-256/2': FrameDiT_G_IMG_B_64_256_2,
    'FrameDiTGIMG-L/64-256/2': FrameDiT_G_IMG_L_64_256_2,
    'FrameDiTGIMG-XL/64-256/2': FrameDiT_G_IMG_XL_64_256_2,

    'FrameDiTGIMG-S/128-512/2-softmax_u': FrameDiT_G_IMG_S_128_512_2_softmax_u,
    'FrameDiTGIMG-B/128-512/2-softmax_u': FrameDiT_G_IMG_B_128_512_2_softmax_u,
    'FrameDiTGIMG-L/128-512/2-softmax_u': FrameDiT_G_IMG_L_128_512_2_softmax_u,
    'FrameDiTGIMG-XL/128-512/2-softmax_u': FrameDiT_G_IMG_XL_128_512_2_softmax_u,

    'FrameDiTGIMG-S/128-512/2': FrameDiT_G_IMG_S_128_512_2,
    'FrameDiTGIMG-B/128-512/2': FrameDiT_G_IMG_B_128_512_2,
    'FrameDiTGIMG-L/128-512/2': FrameDiT_G_IMG_L_128_512_2,
    'FrameDiTGIMG-XL/128-512/2': FrameDiT_G_IMG_XL_128_512_2,
}
