...
"""
    model = FrameDiTHT2V(
        col_dim=1024, # This must match the spatial token count of Latte
        num_col_attn_heads=16, 
        num_row_attn_heads=16,
        qk_col_attn_head_dim=32, # Latte XL usually 1152 dim / 16 heads = 72
        v_col_attn_head_dim=64,
        row_attn_head_dim=72,
        attention_bias=True,
        ...
        in_channels=4,
        out_channels=8,
        num_layers=28, # Latte XL
        patch_size=2,
        sample_size=64, # 256 px / 8 vae
        num_embeds_ada_norm=1000,
        attention_type="default", # Basic spatial attention
        norm_type="ada_norm_single",
        activation_fn='gelu-approximate',
        # caption_channels=1152, # T5
...
if __name__ == '__main__':
    ...
    model = FrameDiTHT2V(
        col_dim=16,
        num_col_attn_heads=8,
        num_row_attn_heads=16,
        qk_col_attn_head_dim=88,
        v_col_attn_head_dim=88,
        row_attn_head_dim=72,
        in_channels=4,
        num_layers=2,
        dropout=0.0,
