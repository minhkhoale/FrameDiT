...
class TransformerBlock(nn.Module):
    """
    A LatteV2 tansformer block with adaptive layer norm zero (adaLN-Zero) conditioning.
    """
...
class LatteV2(nn.Module):
    ...
    def initialize_weights(self):
        ...
        # Zero-out adaLN modulation layers in LatteV2 blocks:
    ...
    def forward_with_cfg(self, x, t, y=None, cfg_scale=7.0, use_fp16=False, text_embedding=None):
        """
        Forward pass of LatteV2, but also batches the unconditional forward pass for classifier-free guidance.
        """
...
def LatteV2_XL_2(**kwargs):
    return LatteV2(depth=28, hidden_size=1152, patch_size=2, num_heads=16, **kwargs)

def LatteV2_XL_4(**kwargs):
    return LatteV2(depth=28, hidden_size=1152, patch_size=4, num_heads=16, **kwargs)

def LatteV2_XL_8(**kwargs):
    return LatteV2(depth=28, hidden_size=1152, patch_size=8, num_heads=16, **kwargs)

def LatteV2_L_2(**kwargs):
    return LatteV2(depth=24, hidden_size=1024, patch_size=2, num_heads=16, **kwargs)

def LatteV2_L_4(**kwargs):
    return LatteV2(depth=24, hidden_size=1024, patch_size=4, num_heads=16, **kwargs)
...
def LatteV2_B_4(**kwargs):
    return LatteV2(depth=12, hidden_size=768, patch_size=4, num_heads=12, **kwargs)

def LatteV2_B_8(**kwargs):
    return LatteV2(depth=12, hidden_size=768, patch_size=8, num_heads=12, **kwargs)

def LatteV2_S_2(**kwargs):
    return LatteV2(depth=12, hidden_size=384, patch_size=2, num_heads=6, **kwargs)

def LatteV2_S_4(**kwargs):
    return LatteV2(depth=12, hidden_size=384, patch_size=4, num_heads=6, **kwargs)
...
if __name__ == '__main__':
    ...
    network = LatteV2_XL_2().to(device)
