...
class FusedMatLatteIMG(nn.Module):
    """
    ...
    def forward(self, x, t, y=None, use_fp16=False, y_image=None, use_image_num=0):
        """
        Forward pass of FusedMatLatteIMG.
...
#============================================================================================
def FusedMatLatteIMG_XL_2(**kwargs):
    return FusedMatLatteIMG(depth=28, hidden_size=1152, patch_size=2, num_row_heads=16, **kwargs)

def FusedMatLatteIMG_XL_4(**kwargs):
    return FusedMatLatteIMG(depth=28, hidden_size=1152, patch_size=4, num_row_heads=16, **kwargs)

def FusedMatLatteIMG_XL_8(**kwargs):
    return FusedMatLatteIMG(depth=28, hidden_size=1152, patch_size=8, num_row_heads=16, **kwargs)

def FusedMatLatteIMG_L_2(**kwargs):
    return FusedMatLatteIMG(depth=24, hidden_size=1024, patch_size=2, num_row_heads=16, **kwargs)

def FusedMatLatteIMG_L_4(**kwargs):
    return FusedMatLatteIMG(depth=24, hidden_size=1024, patch_size=4, num_row_heads=16, **kwargs)

def FusedMatLatteIMG_L_8(**kwargs):
    return FusedMatLatteIMG(depth=24, hidden_size=1024, patch_size=8, num_row_heads=16, **kwargs)

def FusedMatLatteIMG_M_2(**kwargs):
    return FusedMatLatteIMG(depth=12, hidden_size=1024, patch_size=2, num_row_heads=16, **kwargs)

def FusedMatLatteIMG_M_4(**kwargs):
    return FusedMatLatteIMG(depth=12, hidden_size=1024, patch_size=4, num_row_heads=16, **kwargs)

def FusedMatLatteIMG_M_8(**kwargs):
    return FusedMatLatteIMG(depth=12, hidden_size=1024, patch_size=8, num_row_heads=16, **kwargs)

def FusedMatLatteIMG_B_2(**kwargs):
    return FusedMatLatteIMG(depth=12, hidden_size=768, patch_size=2, num_row_heads=12, **kwargs)

def FusedMatLatteIMG_B_4(**kwargs):
    return FusedMatLatteIMG(depth=12, hidden_size=768, patch_size=4, num_row_heads=12, **kwargs)

def FusedMatLatteIMG_B_8(**kwargs):
    return FusedMatLatteIMG(depth=12, hidden_size=768, patch_size=8, num_row_heads=12, **kwargs)

def FusedMatLatteIMG_S_2(**kwargs):
    return FusedMatLatteIMG(depth=12, hidden_size=384, patch_size=2, num_row_heads=6, **kwargs)

def FusedMatLatteIMG_S_4(**kwargs):
    return FusedMatLatteIMG(depth=12, hidden_size=384, patch_size=4, num_row_heads=6, **kwargs)

def FusedMatLatteIMG_S_8(**kwargs):
    return FusedMatLatteIMG(depth=12, hidden_size=384, patch_size=8, num_row_heads=6, **kwargs)

# For image size 256
def FusedMatLatteIMG_XL_256_512_2_concat(**kwargs):
    return FusedMatLatteIMG_XL_2(qk_col_dim=256, v_col_dim=512, num_col_heads=256, fuse_mode='concat', **kwargs)

def FusedMatLatteIMG_XL_256_1024_2_concat(**kwargs):
    return FusedMatLatteIMG_XL_2(qk_col_dim=256, v_col_dim=1024, num_col_heads=256, fuse_mode='concat', **kwargs)
...
def FusedMatLatteIMG_M_1_256_2(**kwargs):
    return FusedMatLatteIMG_M_2(qk_col_dim=1, v_col_dim=256, num_col_heads=1, **kwargs)

def FusedMatLatteIMG_M_4_256_2(**kwargs):
    return FusedMatLatteIMG_M_2(qk_col_dim=4, v_col_dim=256, num_col_heads=4, **kwargs)

def FusedMatLatteIMG_M_4_512_2(**kwargs):
    return FusedMatLatteIMG_M_2(qk_col_dim=4, v_col_dim=512, num_col_heads=4, **kwargs)

def FusedMatLatteIMG_M_8_256_2(**kwargs):
    return FusedMatLatteIMG_M_2(qk_col_dim=8, v_col_dim=256, num_col_heads=8, **kwargs)

def FusedMatLatteIMG_M_16_512_2(**kwargs):
    return FusedMatLatteIMG_M_2(qk_col_dim=16, v_col_dim=512, num_col_heads=16, **kwargs)

def FusedMatLatteIMG_M_16_256_2(**kwargs):
    return FusedMatLatteIMG_M_2(qk_col_dim=16, v_col_dim=256, num_col_heads=16, **kwargs)

def FusedMatLatteIMG_M_16_256_2(**kwargs):
    return FusedMatLatteIMG_M_2(qk_col_dim=16, v_col_dim=256, num_col_heads=16, **kwargs)


# def FusedMatLatteIMG_M_16_64_2(**kwargs):
#     return FusedMatLatteIMG_M_2(qk_col_dim=16, v_col_dim=64, num_col_heads=16, **kwargs)

def FusedMatLatteIMG_S_64_256_2_concat(**kwargs):
    return FusedMatLatteIMG_S_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, fuse_mode='concat', **kwargs)

def FusedMatLatteIMG_B_64_256_2_concat(**kwargs):
    return FusedMatLatteIMG_B_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, fuse_mode='concat', **kwargs)

def FusedMatLatteIMG_L_64_256_2_concat(**kwargs):
    return FusedMatLatteIMG_L_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, fuse_mode='concat', **kwargs)

def FusedMatLatteIMG_XL_64_256_2_concat(**kwargs):
    return FusedMatLatteIMG_XL_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, fuse_mode='concat', **kwargs)

def FusedMatLatteIMG_M_32_256_2(**kwargs):
    return FusedMatLatteIMG_M_2(qk_col_dim=32, v_col_dim=256, num_col_heads=32, **kwargs)

def FusedMatLatteIMG_M_64_64_2(**kwargs):
    return FusedMatLatteIMG_M_2(qk_col_dim=64, v_col_dim=64, num_col_heads=64, **kwargs)

def FusedMatLatteIMG_M_64_256_2_gated(**kwargs):
    return FusedMatLatteIMG_M_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, fuse_mode='gated', **kwargs)

def FusedMatLatteIMG_M_32_256_2_concat(**kwargs):
    return FusedMatLatteIMG_M_2(qk_col_dim=32, v_col_dim=256, num_col_heads=32, fuse_mode='concat', **kwargs)

def FusedMatLatteIMG_M_16_256_2_concat(**kwargs):
    return FusedMatLatteIMG_M_2(qk_col_dim=16, v_col_dim=256, num_col_heads=16, fuse_mode='concat', **kwargs)

def FusedMatLatteIMG_M_64_256_2_concat(**kwargs):
    return FusedMatLatteIMG_M_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, fuse_mode='concat', **kwargs)

def FusedMatLatteIMG_M_64_256_2_sum(**kwargs):
    return FusedMatLatteIMG_M_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, fuse_mode='sum', **kwargs)

def FusedMatLatteIMG_M_16_64_2_gated(**kwargs):
    return FusedMatLatteIMG_M_2(qk_col_dim=16, v_col_dim=64, num_col_heads=16, fuse_mode='gated', **kwargs)

def FusedMatLatteIMG_M_16_64_2_concat(**kwargs):
    return FusedMatLatteIMG_M_2(qk_col_dim=16, v_col_dim=64, num_col_heads=16, fuse_mode='concat', **kwargs)

def FusedMatLatteIMG_M_16_64_2_sum(**kwargs):
    return FusedMatLatteIMG_M_2(qk_col_dim=16, v_col_dim=64, num_col_heads=16, fuse_mode='sum', **kwargs)

def FusedMatLatteIMG_M_4_64_2_concat(**kwargs):
    return FusedMatLatteIMG_M_2(qk_col_dim=4, v_col_dim=64, num_col_heads=4, fuse_mode='concat', **kwargs)

def FusedMatLatteIMG_M_2_onlylocal(**kwargs):
    return FusedMatLatteIMG_M_2(qk_col_dim=None, v_col_dim=None, num_col_heads=None, fuse_mode='local', **kwargs)


# For image size 64
def FusedMatLatteIMG_B_16_16_2(**kwargs):
    return FusedMatLatteIMG_B_2(qk_col_dim=16, v_col_dim=16, num_col_heads=16, **kwargs)

#============================================================================================
FusedMatLatteIMG_models = {
    'FusedMatLatteIMG-S/64-256/2-concat': FusedMatLatteIMG_S_64_256_2_concat,

    'FusedMatLatteIMG-B/64-256/2-concat': FusedMatLatteIMG_B_64_256_2_concat,

    'FusedMatLatteIMG-L/64-256/2-concat': FusedMatLatteIMG_L_64_256_2_concat,

    'FusedMatLatteIMG-XL/64-256/2-concat': FusedMatLatteIMG_XL_64_256_2_concat,

    'FusedMatLatteIMG-M/4-64/2-concat': FusedMatLatteIMG_M_4_64_2_concat,
    'FusedMatLatteIMG-M/16-64/2-gated': FusedMatLatteIMG_M_16_64_2_gated,
    'FusedMatLatteIMG-M/16-64/2-concat': FusedMatLatteIMG_M_16_64_2_concat,
    'FusedMatLatteIMG-M/16-64/2-sum': FusedMatLatteIMG_M_16_64_2_sum,

    'FusedMatLatteIMG-M/32-256/2-concat': FusedMatLatteIMG_M_32_256_2_concat,
    'FusedMatLatteIMG-M/16-256/2-concat': FusedMatLatteIMG_M_16_256_2_concat,


    'FusedMatLatteIMG-M/64-256/2-gated': FusedMatLatteIMG_M_64_256_2_gated,
    'FusedMatLatteIMG-M/64-256/2-concat': FusedMatLatteIMG_M_64_256_2_concat,
    'FusedMatLatteIMG-M/64-256/2-sum': FusedMatLatteIMG_M_64_256_2_sum,
    ...
    'FusedMatLatteIMG-XL/256-1024/2-concat': FusedMatLatteIMG_XL_256_1024_2_concat,
}
