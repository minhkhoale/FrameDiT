...
#################################################################################
#                                 Core FrameDiT_G Model                                #
#################################################################################

class TransformerBlock(nn.Module):
    """
    A FrameDiT_G tansformer block with adaptive layer norm zero (adaLN-Zero) conditioning.
    """
...
class FrameDiT_G(nn.Module):
    ...
    def initialize_weights(self):
        ...
        # Zero-out adaLN modulation layers in FrameDiT_G blocks:
    ...
    def forward_with_cfg(self, x, t, y=None, cfg_scale=7.0, use_fp16=False, text_embedding=None):
        """
        Forward pass of FrameDiT_G, but also batches the unconditional forward pass for classifier-free guidance.
        """
...
#============================================================================================
def FrameDiT_G_XL_2(**kwargs):
    return FrameDiT_G(depth=28, hidden_size=1152, patch_size=2, num_row_heads=16, **kwargs)

def FrameDiT_G_L_2(**kwargs):
    return FrameDiT_G(depth=24, hidden_size=1024, patch_size=2, num_row_heads=16, **kwargs)

def FrameDiT_G_B_2(**kwargs):
    return FrameDiT_G(depth=12, hidden_size=768, patch_size=2, num_row_heads=12, **kwargs)

def FrameDiT_G_S_2(**kwargs):
    return FrameDiT_G(depth=12, hidden_size=384, patch_size=2, num_row_heads=6, **kwargs)


def FrameDiT_G_S_64_256_2_softmax_u(**kwargs):
    return FrameDiT_G_S_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, u_type='softmax', **kwargs)

def FrameDiT_G_B_64_256_2_softmax_u(**kwargs):
    return FrameDiT_G_B_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, u_type='softmax', **kwargs)

def FrameDiT_G_L_64_256_2_softmax_u(**kwargs):
    return FrameDiT_G_L_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, u_type='softmax', **kwargs)

def FrameDiT_G_XL_64_256_2_softmax_u(**kwargs):
    return FrameDiT_G_XL_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, u_type='softmax', **kwargs)


def FrameDiT_G_S_64_256_2(**kwargs):
    return FrameDiT_G_S_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64,  **kwargs)

def FrameDiT_G_B_64_256_2(**kwargs):
    return FrameDiT_G_B_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, **kwargs)

def FrameDiT_G_L_64_256_2(**kwargs):
    return FrameDiT_G_L_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, **kwargs)

def FrameDiT_G_XL_64_256_2(**kwargs):
    return FrameDiT_G_XL_2(qk_col_dim=64, v_col_dim=256, num_col_heads=64, **kwargs)


def FrameDiT_G_S_128_512_2_softmax_u(**kwargs):
    return FrameDiT_G_S_2(qk_col_dim=128, v_col_dim=512, num_col_heads=64, u_type='softmax', **kwargs)

def FrameDiT_G_B_128_512_2_softmax_u(**kwargs):
    return FrameDiT_G_B_2(qk_col_dim=128, v_col_dim=512, num_col_heads=64, u_type='softmax', **kwargs)

def FrameDiT_G_L_128_512_2_softmax_u(**kwargs):
    return FrameDiT_G_L_2(qk_col_dim=128, v_col_dim=512, num_col_heads=64, u_type='softmax', **kwargs)

def FrameDiT_G_XL_128_512_2_softmax_u(**kwargs):
    return FrameDiT_G_XL_2(qk_col_dim=128, v_col_dim=512, num_col_heads=64, u_type='softmax', **kwargs)


def FrameDiT_G_S_128_512_2(**kwargs):
    return FrameDiT_G_S_2(qk_col_dim=128, v_col_dim=512, num_col_heads=64,  **kwargs)

def FrameDiT_G_B_128_512_2(**kwargs):
    return FrameDiT_G_B_2(qk_col_dim=128, v_col_dim=512, num_col_heads=64, **kwargs)

def FrameDiT_G_L_128_512_2(**kwargs):
    return FrameDiT_G_L_2(qk_col_dim=128, v_col_dim=512, num_col_heads=64, **kwargs)

def FrameDiT_G_XL_128_512_2(**kwargs):
    return FrameDiT_G_XL_2(qk_col_dim=128, v_col_dim=512, num_col_heads=64, **kwargs)



#============================================================================================
FrameDiTG_models = {
    'FrameDiTG-S/64-256/2-softmax_u': FrameDiT_G_S_64_256_2_softmax_u,
    'FrameDiTG-B/64-256/2-softmax_u': FrameDiT_G_B_64_256_2_softmax_u,
    'FrameDiTG-L/64-256/2-softmax_u': FrameDiT_G_L_64_256_2_softmax_u,
    'FrameDiTG-XL/64-256/2-softmax_u': FrameDiT_G_XL_64_256_2_softmax_u,

    'FrameDiTG-S/64-256/2': FrameDiT_G_S_64_256_2,
    'FrameDiTG-B/64-256/2': FrameDiT_G_B_64_256_2,
    'FrameDiTG-L/64-256/2': FrameDiT_G_L_64_256_2,
    'FrameDiTG-XL/64-256/2': FrameDiT_G_XL_64_256_2,

    'FrameDiTG-S/128-512/2-softmax_u': FrameDiT_G_S_128_512_2_softmax_u,
    'FrameDiTG-B/128-512/2-softmax_u': FrameDiT_G_B_128_512_2_softmax_u,
    'FrameDiTG-L/128-512/2-softmax_u': FrameDiT_G_L_128_512_2_softmax_u,
    'FrameDiTG-XL/128-512/2-softmax_u': FrameDiT_G_XL_128_512_2_softmax_u,

    'FrameDiTG-S/128-512/2': FrameDiT_G_S_128_512_2,
    'FrameDiTG-B/128-512/2': FrameDiT_G_B_128_512_2,
    'FrameDiTG-L/128-512/2': FrameDiT_G_L_128_512_2,
    'FrameDiTG-XL/128-512/2': FrameDiT_G_XL_128_512_2,
}
